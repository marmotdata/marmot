...
<div class="space-y-2">
	...
	{:else}
		<textarea
			...
			{rows}
			{disabled}
			class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:text-gray-100 disabled:opacity-50 font-mono text-sm"
		></textarea>
		{#if showPreview}
