		...
		<div class="flex items-center justify-center min-h-screen p-4">
			...
			>
				...
				<div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
					...
					<button
						type="button"
						class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 dark:border-gray-600 dark:border-gray-600 shadow-sm px-4 py-2 bg-white dark:bg-gray-800 dark:bg-gray-800 text-base font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-800 dark:bg-gray-900 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 dark:focus:ring-orange-400 sm:mt-0 sm:w-auto sm:text-sm"
						on:click={onCancel}
					>
						Cancel
					</button>
