...
<Head>
  ...
  <meta name="twitter:image" content="https://marmotdata.io/img/resources/marmot-vs-atlan.png" />
  ...
  <meta property="og:image" content="https://marmotdata.io/img/resources/marmot-vs-atlan.png" />
...
<ComparisonTable
  ...
  rows={[
    ...
    { feature: "Connectors", cells: [
      "70+ plugins, plus catalog-as-code",
...
Marmot ships 70+ plugins spanning databases, warehouses, lakes, object storage, streaming, orchestration, compute, BI and search. For anything without a plugin yet, Marmot's official Terraform and Pulumi providers (`marmot_asset`, `marmot_lineage`) populate assets and lineage straight from the infrastructure you already define, so a source still lands in the catalog from code you are writing anyway. Atlan still leads on managed breadth, and you are paying it to do the connector work for you. The trade is narrower than it was: with 70+ plugins plus catalog-as-code you cover the same ground yourself, and you keep the whole thing in your own infrastructure.
