---
slug: ai-is-making-assumptions-about-your-data
title: "AI is making assumptions about your data, and getting them wrong"
authors:
  - name: Charlie Haley
    url: https://github.com/charlie-haley
image: /img/ai-source-of-truth-banner.png
description: "AI assistants write code well but are blind to your data: what tables exist, who owns them, what business terms mean. Why agents need a governed source of truth, and how a data catalog gives them real context over MCP."
tags: [ai-agents, mcp, context-layer, data-catalog]
keywords:
  - ai context for data
  - llm data assumptions
  - ai source of truth
  - mcp data catalog
---
