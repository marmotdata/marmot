    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-800">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-3 sm:flex sm:flex-row items-center justify-center gap-2 sm:gap-14">
            <div className="text-center">
              <div className="text-3xl sm:text-6xl font-extrabold tracking-tight gradient-text">
                500k+
              </div>
              <div className="mt-1 sm:mt-2 text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">
                Assets
              </div>
            </div>
            <div className="hidden sm:block w-px h-16 bg-gray-200 dark:bg-gray-700" />
            <div className="text-center border-x border-gray-200 dark:border-gray-700 sm:border-0">
              <div className="text-3xl sm:text-6xl font-extrabold tracking-tight gradient-text">
                100+
              </div>
              <div className="mt-1 sm:mt-2 text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">
