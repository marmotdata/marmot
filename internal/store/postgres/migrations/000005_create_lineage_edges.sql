...
DROP INDEX IF EXISTS idx_lineage_edges_job_not_null;
DROP INDEX IF EXISTS idx_lineage_edges_target_source;
DROP INDEX IF EXISTS idx_lineage_edges_source_target;
