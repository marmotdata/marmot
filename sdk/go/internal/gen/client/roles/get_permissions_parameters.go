...
func NewGetPermissionsParams() *GetPermissionsParams {
	return NewGetPermissionsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPermissionsParams].
