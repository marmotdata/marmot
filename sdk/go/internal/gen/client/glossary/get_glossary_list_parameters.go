...
// NewGetGlossaryListParamsWithHTTPClient creates a new GetGlossaryListParams object
// with the ability to set a custom HTTPClient for a request.
func NewGetGlossaryListParamsWithHTTPClient(client *http.Client) *GetGlossaryListParams {
	return &GetGlossaryListParams{
		HTTPClient: client,
	}
}
...
/*
GetGlossaryListParams contains all the parameters to send to the API endpoint

	for the get glossary list operation.
...
func (o *GetGlossaryListParams) WithDefaults() *GetGlossaryListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get glossary list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetGlossaryListParams) SetDefaults() {
	var (
