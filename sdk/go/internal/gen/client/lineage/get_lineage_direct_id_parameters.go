...
// NewGetLineageDirectIDParams creates a new GetLineageDirectIDParams object,
...
// NewGetLineageDirectIDParamsWithHTTPClient creates a new GetLineageDirectIDParams object
// with the ability to set a custom HTTPClient for a request.
func NewGetLineageDirectIDParamsWithHTTPClient(client *http.Client) *GetLineageDirectIDParams {
	return &GetLineageDirectIDParams{
		HTTPClient: client,
	}
}
...
/*
GetLineageDirectIDParams contains all the parameters to send to the API endpoint

	for the get lineage direct ID operation.
...
func (o *GetLineageDirectIDParams) WithDefaults() *GetLineageDirectIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get lineage direct ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetLineageDirectIDParams) SetDefaults() {
