...
func NewPutProductsIDParams() *PutProductsIDParams {
	return NewPutProductsIDParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutProductsIDParams].
...
type PutProductsIDParams struct {
	...
	//
	// Fields to update
	Product *models.UpdateDataProductRequest
...
func (o *PutProductsIDParams) WithProduct(product *models.UpdateDataProductRequest) *PutProductsIDParams {
	o.SetProduct(product)
	return o
}

// SetProduct adds the product to the put products ID params.
func (o *PutProductsIDParams) SetProduct(product *models.UpdateDataProductRequest) {
	o.Product = product
}
