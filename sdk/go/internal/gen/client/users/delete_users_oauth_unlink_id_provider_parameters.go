...
// NewDeleteUsersOauthUnlinkIDProviderParams creates a new DeleteUsersOauthUnlinkIDProviderParams object,
...
// NewDeleteUsersOauthUnlinkIDProviderParamsWithHTTPClient creates a new DeleteUsersOauthUnlinkIDProviderParams object
// with the ability to set a custom HTTPClient for a request.
func NewDeleteUsersOauthUnlinkIDProviderParamsWithHTTPClient(client *http.Client) *DeleteUsersOauthUnlinkIDProviderParams {
	return &DeleteUsersOauthUnlinkIDProviderParams{
		HTTPClient: client,
	}
}
...
/*
DeleteUsersOauthUnlinkIDProviderParams contains all the parameters to send to the API endpoint

	for the delete users oauth unlink ID provider operation.
...
func (o *DeleteUsersOauthUnlinkIDProviderParams) WithDefaults() *DeleteUsersOauthUnlinkIDProviderParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete users oauth unlink ID provider params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteUsersOauthUnlinkIDProviderParams) SetDefaults() {
