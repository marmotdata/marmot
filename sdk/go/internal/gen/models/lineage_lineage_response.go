...
func (m *LineageLineageResponse) validateEdges(formats strfmt.Registry) error {
...
func (m *LineageLineageResponse) validateNodes(formats strfmt.Registry) error {
...
func (m *LineageLineageResponse) contextValidateEdges(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LineageLineageResponse) contextValidateNodes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LineageLineageResponse) UnmarshalBinary(b []byte) error {
	var res LineageLineageResponse
