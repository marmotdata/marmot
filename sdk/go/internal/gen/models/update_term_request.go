...
//
// swagger:model UpdateTermRequest
...
// Validate validates this update term request
func (m *UpdateTermRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
// ContextValidate validate this update term request based on the context it is used
func (m *UpdateTermRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateTermRequest) contextValidateOwners(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateTermRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
