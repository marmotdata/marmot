...
func (m *V1GlossaryCreateTermRequest) validateDefinition(formats strfmt.Registry) error {
...
func (m *V1GlossaryCreateTermRequest) validateName(formats strfmt.Registry) error {
...
func (m *V1GlossaryCreateTermRequest) validateOwners(formats strfmt.Registry) error {
...
func (m *V1GlossaryCreateTermRequest) contextValidateOwners(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1GlossaryCreateTermRequest) UnmarshalBinary(b []byte) error {
	var res V1GlossaryCreateTermRequest
