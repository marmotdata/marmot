...
func (m *V1RunsRunEntitiesResponse) validateEntities(formats strfmt.Registry) error {
...
func (m *V1RunsRunEntitiesResponse) contextValidateEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1RunsRunEntitiesResponse) UnmarshalBinary(b []byte) error {
	var res V1RunsRunEntitiesResponse
