...
class Configuration:
    ...
    conf = marmot.generated.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("marmot.generated")
    ...
    def get_basic_auth_token(self) -> str | None:
        ...
        return "Basic " + base64.b64encode((username + ":" + password).encode("utf-8")).decode(
            "utf-8"
        )
