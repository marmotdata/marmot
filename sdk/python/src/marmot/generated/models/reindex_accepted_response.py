...
class ReindexAcceptedResponse(BaseModel):
    ...
    message: StrictStr | None = Field(
        default=None, json_schema_extra={"examples": ["Reindex started"]}
    )
    status: StrictStr | None = Field(default=None, json_schema_extra={"examples": ["accepted"]})
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate({"message": obj.get("message"), "status": obj.get("status")})
