...
class BatchLineageResult(BaseModel):
    """
    BatchLineageResult
    """
    ...
    status: StrictStr | None = Field(
        default=None, description='"created", "duplicate", or "existing"'
    )
    __properties: ClassVar[list[str]] = ["edge", "status"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate(
            {
                "edge": LineageEdge.from_dict(obj["edge"]) if obj.get("edge") is not None else None,
