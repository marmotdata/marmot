...
class AssetTerm(BaseModel):
    ...
    created_by_username: StrictStr | None = None
    definition: StrictStr | None = None
    source: StrictStr | None = Field(default=None, description='"user" or "plugin:name"')
    term_id: StrictStr | None = None
    term_name: StrictStr | None = None
