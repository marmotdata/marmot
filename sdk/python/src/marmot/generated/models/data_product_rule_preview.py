...
class DataProductRulePreview(BaseModel):
    """
    DataProductRulePreview
    """

    asset_count: StrictInt | None = None
    asset_ids: list[StrictStr] | None = None
    errors: list[StrictStr] | None = None
    __properties: ClassVar[list[str]] = ["asset_count", "asset_ids", "errors"]
