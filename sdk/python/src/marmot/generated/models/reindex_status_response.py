...
class ReindexStatusResponse(BaseModel):
    ...
    es_configured: StrictBool | None = None
    running: StrictBool | None = None
    __properties: ClassVar[list[str]] = ["es_configured", "running"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate(
            {"es_configured": obj.get("es_configured"), "running": obj.get("running")}
        )
