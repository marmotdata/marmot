...
class DataProductAssetsResult(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["asset_ids", "total"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate({"asset_ids": obj.get("asset_ids"), "total": obj.get("total")})
