...
class CreateServiceAccountAPIKeyRequest(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["expires_in_days", "name"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate(
            {"expires_in_days": obj.get("expires_in_days"), "name": obj.get("name")}
        )
