...
class GetRuns200Response(BaseModel):
    ...
    pipelines: list[StrictStr] | None = None
    runs: list[PluginRun] | None = None
    total: StrictInt | None = None
    __properties: ClassVar[list[str]] = ["limit", "offset", "pipelines", "runs", "total"]
        ...
        return cls.model_validate(
            {
                ...
                "runs": [PluginRun.from_dict(_item) for _item in obj["runs"]]
