...
class DataProductListResult(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["data_products", "total"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        return cls.model_validate(
            {
                "data_products": [DataProduct.from_dict(_item) for _item in obj["data_products"]]
                if obj.get("data_products") is not None
                else None,
                "total": obj.get("total"),
            }
        )
