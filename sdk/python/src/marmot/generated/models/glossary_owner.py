...
class GlossaryOwner(BaseModel):
    ...
    type: StrictStr | None = Field(default=None, description='"user" or "team"')
    username: StrictStr | None = Field(default=None, description="Only for user owners")
