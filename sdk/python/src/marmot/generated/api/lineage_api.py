...
class LineageApi:
    ...
    async def api_v1_lineage_post(
        ...
        _param = self._api_v1_lineage_post_serialize(
            run_event=run_event,
    ...
    @validate_call
    async def api_v1_lineage_post_with_http_info(
        self,
        run_event: Annotated[RunEvent, Field(description="OpenLineage run event")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
    ...
    @validate_call
    async def api_v1_lineage_post_without_preload_content(
        self,
        run_event: Annotated[RunEvent, Field(description="OpenLineage run event")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
    ...
    def api_v1_lineage_post_sync(
        ...
        Synchronous variant of :meth:`api_v1_lineage_post`. It calls the asynchronous
        method and blocks until it completes.
        """
        return run_sync(
            self.api_v1_lineage_post(
                run_event=run_event,
    ...
    @validate_call
    def api_v1_lineage_post_sync_with_http_info(
        self,
        run_event: Annotated[RunEvent, Field(description="OpenLineage run event")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        ...
        Synchronous variant of :meth:`api_v1_lineage_post_with_http_info`. It calls the
        asynchronous method and blocks until it completes.
        """
        return run_sync(
            self.api_v1_lineage_post_with_http_info(
                run_event=run_event,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def api_v1_lineage_post_sync_without_preload_content(
        self,
        run_event: Annotated[RunEvent, Field(description="OpenLineage run event")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        ...
        Synchronous variant of :meth:`api_v1_lineage_post_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """
        return run_sync(
            self.api_v1_lineage_post_without_preload_content(
                run_event=run_event,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    def _api_v1_lineage_post_serialize(
        self,
        run_event,
        _request_auth,
        _content_type,
