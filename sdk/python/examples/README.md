...
| [`local_oidc_issuer.py`](custom_workload_identity/local_oidc_issuer.py) | Not an SDK example: a throwaway OIDC issuer so the exchange can be tested locally. See below. |
