...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/memory/{entityType}/{entityId}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/RememberRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/memory/{entityType}/{entityId}/search": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/MemorySearchResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/memory/{entityType}/{entityId}/{memoryId}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "Memory": {
            ...
            "properties": {
                ...
                "score": {
                    "description": "Score is the search relevance; higher is more relevant. Set on search\nresults only.",
                    "type": "number"
                },
                "session_id": {
                    "description": "SessionID is the session the entry was created in.",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
