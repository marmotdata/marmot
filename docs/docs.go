    ...
    "paths": {
        ...
        "/api/v1/domains": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Domain; parent_id null creates a root",
                        "name": "domain",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_domains.CreateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1_domains.Capabilities"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/domains/import": {
            "post": {
                ...
                "operationId": "importDomainMemberships",
                "parameters": [
                    {
                        "description": "Source path, value-to-domain mapping and apply flag",
                        "name": "import",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ImportInput"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ImportReport"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_domains.UpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/domains/{id}/members": {
            "put": {
                ...
                "operationId": "assignDomainMembers",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Domain ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_domains.MembersRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1_domains.MoveRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/domains/{id}/roles": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.RoleAssignment"
                            }
                        }
                    },
                    "404": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Subject and role",
                        "name": "grant",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.GrantInput"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/importer.ColumnInfo"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "domain.ImportReport": {
            ...
            "properties": {
                ...
                "mapped": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ImportValue"
                    }
                },
                "unmapped": {
                    "type": "array",
        ...
        "domain.RoleAssignment": {
            ...
            "properties": {
                ...
                "subject_missing": {
                    "description": "SubjectMissing marks a row whose user, team or service account was deleted.",
                    "type": "boolean"
                },
                "subject_name": {
                    "type": "string"
        ...
        "v1_domains.Capabilities": {
            "type": "object",
            "properties": {
                "admin": {
                    "description": "Admin: manage its subdomains and role assignments.",
                    "type": "boolean"
                },
                "domain_id": {
                    "type": "string"
