...
func (m *V1TeamsSearchOwnersResponse) validateOwners(formats strfmt.Registry) error {
...
func (m *V1TeamsSearchOwnersResponse) contextValidateOwners(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1TeamsSearchOwnersResponse) UnmarshalBinary(b []byte) error {
	var res V1TeamsSearchOwnersResponse
